                ...
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8">
                    <div className="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <div className="px-6 py-6 flex gap-x-8">
                            ...
                            <Link className="flex-1 p-2 border-2 border-emerald-600 bg-emerald-600/20 hover:bg-emerald-600/40 text-white text-center cursor-pointer" href={route('mangas.index')}>
                                <div>
                                    манга
                                </div>
                            </Link>
