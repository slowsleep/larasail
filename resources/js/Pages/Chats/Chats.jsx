        ...
        >
            ...
            <div className="py-12">
                <div className="max-w-7xl mx-auto sm:px-6 lg:px-8 h-screen">
                    <div className="bg-white dark:bg-zinc-800 overflow-hidden shadow-sm sm:rounded-lg p-6 flex flex-col gap-y-4 h-full">
                        {error ? (
                        ...
                        <div className="flex flex-row gap-x-4 h-full">
                            <div className="flex flex-col w-1/3 bg-zinc-400 p-2">
                                <ChatList chats={chats} auth={auth}/>
                            </div>
                            <div className="flex flex-col w-full bg-zinc-400 p-2">
                                {chat ?
